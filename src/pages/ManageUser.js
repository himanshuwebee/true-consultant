...
import "../components/CSS/ManageUser.css";
...
import { CData, udata , gdata } from "../components/CUG";
            ...
            <div className="manage-user-main-container">
                <div className="manage-user-heading-container">
                    ...
                    <div className="filter-buttons">
                        <button
                            className={`manage-user-Client ${activeTab === "Client" ? "active" : ""
                                }`}
                        ...
                        <button
                            className={`manage-user-User ${activeTab === "User" ? "active" : ""
                                }`}
                        ...
                        <button
                            className={`manage-user-Group ${activeTab === "Group" ? "active" : ""
                                }`}
